...
> 진행 상태(2026-07-23): **V4-0 통과, V4-1R2 구현 및 누적 320건 범위검토 완료.**
...
> taxonomy는 148노드·572 aliases, version 3다. 기존 V4-2 시범 결과 2건은 새 필수 필드가
> 없는 구형 결과이므로 완료본으로 인정하지 않고 재추출한다. 다음은 국문 SPA 1건 V4-2 재추출이다.
