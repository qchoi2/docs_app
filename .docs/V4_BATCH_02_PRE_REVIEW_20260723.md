...
|---|---:|---:|---:|---:|---:|
| `a51842fc51010f69` | SPA | 영문 | 171 | 15 | 25 |
...
- 후보 원문·좌표 불일치: 0건
- 당시 운영 DB: 기존 209 item·60문서 유지
- 감사 파일: `cs_index/v4_batch_02_pre_review_audit.json`

75건의 이슈는 입력에 존재하는 별지·Disclosure Schedule을 아직 문맥 검수하지
않았기 때문에 의도적으로 `partial`로 둔 결과다. 오류나 부재 판정이 아니다.
2026-07-24 최종 검수·적재 결과는
`.docs/V4_BATCH_02_FINAL_20260724.md`를 참조한다.
